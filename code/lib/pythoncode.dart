...
class MyPythonCode extends StatefulWidget {
  static String python_op;
  @override
  _MyPythonStateCode createState() => _MyPythonStateCode();
}

class _MyPythonStateCode extends State<MyPythonCode> {
  String ip;
  ...
  Widget build(BuildContext context) {
    ...
    onrun() async {
      ...
      var url = Uri.parse(
          'http://${ip}/cgi-bin/listfiles/python.py?name=sidd&lan=python&file=$file&x=$cmd');
      try {
